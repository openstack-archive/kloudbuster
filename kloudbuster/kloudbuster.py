    ...
    def run_test(self, test_only=False):
        ...
        while 1:
            ...
            if self.tsdb_connector:
                self.final_result['tsdb'] = self.tsdb_connector.get_results(start_time=start_time)
...
def main():
    ...
    tsdb_connector = getattr(tsdb_module, kb_config.tsdb_class)(
        step_size=kb_config.tsdb_step_size,
        wait_time=kb_config.tsdb_wait_time) if CONF.tsdb else None
